...
export class Backend implements backendInterface {
    ...
    async bookClass(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.bookClass(arg0, arg1, arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async freeTrial(arg0: string, arg1: string, arg2: string, arg3: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.freeTrial(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllFreeTrials(): Promise<Array<FreeTrialSignup>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllFreeTrials();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllNewsletterSignups(): Promise<Array<string>> {
        if (this.processError) {
            try {
